...
const signUpSuccess = function (response) {
  ...
  const message = (`<p>Sign up success</p>
    <img src="public/img/sign_up_success.jpg" alt="sign in success">`)
...
const signUpError = function (error) {
  ...
  const message = (`<p>Sign up error</p>
    <img src="public/img/sign_up_error.jpg" alt="sign up error">`)
  $(`#signUpEmptyDiv`).append(message)
  clearFormFields()
}
...
const signInSuccess = function (response) {
  ...
  const message = (`<p>Sign in success</p>
    <img src="public/img/sign_in.jpg" alt="sign in success">`)
...
const signInError = function (error) {
  ...
  const message = (`<p>Sign in error message</p>
    <img src="public/img/sign_in_error.jpg" alt="sign in error">`)
  $(`#signInEmptyDiv`).append(message)
  clearFormFields()
}
...
const changePasswordSuccess = function () {
  ...
  const message = (`<p>Change password success message</p>
    <img src="public/img/change_pass_success.jpg" alt="change password success">`)
...
const changePasswordError = function (error) {
  ...
  const message = (`<p>Change Password Error</p>
    <img src="public/img/incorrect_password.jpg" alt="change password error">`)
  $(`#changePasswordEmptyDiv`).append(message)
  clearFormFields()
}
...
const signOutSuccess = function () {
  ...
  const message = (`<p>Sign out success message</p>
    <img src="public/img/sign_out_success.jpg" alt="sign out success">`)
...
const signOutError = function (error) {
  ...
  const message = (`<p>Sign out error message</p>
    <img src="public/img/sign_out_error.jpg" alt="sign out error">`)
  $(`#signOutEmptyDiv`).append(message)
  clearFormFields()
}
