...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://jot-api.herokuapp.com/',
...
var jotEvents = __webpack_require__(14);
...
var authApi = __webpack_require__(12);
...
var revealJotSection = function revealJotSection() {
  var jotSection = document.getElementById('jotSection');
  jotSection.classList.remove('hidden');
};

var revealChangePassSignOut = function revealChangePassSignOut() {
  revealJotSection();
  var userAuthInternal = document.getElementById('userAuthInternal');
  userAuthInternal.classList.remove('hidden');
};

var revealSignUpSignIn = function revealSignUpSignIn() {
  hideJotSection();
  var userAuthExternal = document.getElementById('userAuthExternal');
  userAuthExternal.classList.remove('hidden');
};

var hideJotSection = function hideJotSection() {
  var jotSection = document.getElementById('jotSection');
  jotSection.classList.add('hidden');
};

var hideChangePassSignOut = function hideChangePassSignOut() {
  var userAuthInternal = document.getElementById('userAuthInternal');
  userAuthInternal.classList.add('hidden');
};

var hideSignUpSignIn = function hideSignUpSignIn() {
  var userAuthExternal = document.getElementById('userAuthExternal');
  userAuthExternal.classList.add('hidden');
};

var clearMessageDiv = function clearMessageDiv() {
...
var clearJotListMessagesForms = function clearJotListMessagesForms() {
  $('#listOfJots').html('');
...
var signUpSuccess = function signUpSuccess(response) {
  clearMessageDiv();
  var message = '<p>You signed up! We are happy you joined Jot, now please login.</p>';
...
var signUpError = function signUpError() {
  clearMessageDiv();
  var message = '<p>Sorry, something went wrong. Make sure you are using a new email and you are typing in your password correctly.</p>';
  $('#userFacingMessages').append(message);
  clearFormFields();
};
...
var signInSuccess = function signInSuccess(response) {
  ...
  var message = '<p>Welcome to Jot! You are now signed in.</p>';
  $('#userFacingMessages').append(message);
  clearFormFields();
...
var signInError = function signInError() {
  clearMessageDiv();
  var message = '<p>Sorry, it would appear something went wrong while trying to sign in. Please make sure you sign up first and type all credentials correctly.</p>';
  $('#userFacingMessages').append(message);
  clearFormFields();
};
...
var changePasswordSuccess = function changePasswordSuccess() {
  clearMessageDiv();
  var message = '<p>You successfully changed your password, careful not to forget your new one!</p>';
  $('#userFacingMessages').append(message);
  clearFormFields();
};
...
var changePasswordError = function changePasswordError() {
  clearMessageDiv();
  var message = '<p>Sorry, something went wrong while changing your password. Please double check that you input the correct credentials.</p>';
  $('#userFacingMessages').append(message);
  clearFormFields();
};
...
var signOutSuccess = function signOutSuccess() {
  ...
  clearMessageDiv();
  var message = '<p>You are now signed out of Jot, come back soon!</p>';
  $('#userFacingMessages').append(message);
  clearFormFields();
...
var signOutError = function signOutError() {
  clearMessageDiv();
  var message = '<p>Sorry, something went wrong while signing out, please try again soon!</p>';
  $('#userFacingMessages').append(message);
  clearFormFields();
};
...
var getFormFields = __webpack_require__(4);
var jotApi = __webpack_require__(15);
var jotUi = __webpack_require__(16);
var store = __webpack_require__(3);

var onCreateJot = function onCreateJot(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  jotApi.createJot(data).then(jotUi.createJotSuccess).then(jotApi.indexJots).then(jotUi.runHandlebars).catch(jotUi.createJotError);
};

var onIndexJots = function onIndexJots(event) {
  event.preventDefault();
  jotApi.indexJots().then(jotUi.runHandlebars).then(jotUi.indexJotsSuccess).catch(jotUi.indexJotsError);
};

var onDestroyJot = function onDestroyJot(event) {
  event.preventDefault();
  var jotId = event.target.parentElement.parentElement.getAttribute('data-id');
  jotApi.destroyJot(jotId).then(jotUi.destroyJotSuccess).then(jotApi.indexJots).then(jotUi.runHandlebars).catch(jotUi.destroyJotError);
};

var onRevealJotEditor = function onRevealJotEditor(event) {
  event.preventDefault();
  var jotId = event.target.parentElement.parentElement.getAttribute('data-id');
  // Reveal Form
  var updateJotForm = event.target.parentElement.parentElement.getElementsByClassName('update-form-jot-' + jotId);
  updateJotForm[0].classList.remove('hidden');
  // Hide Jot Elements
  var jotName = document.getElementsByClassName('jot-name-' + jotId);
  jotName[0].classList.add('hidden');
  var jotContent = document.getElementsByClassName('jot-content-' + jotId);
  jotContent[0].classList.add('hidden');
};

var onUpdateJot = function onUpdateJot(event) {
  event.preventDefault();
  var data = getFormFields(event.target.parentElement.parentElement);
  store.update = event.target.getAttribute('data-id');
  jotApi.updateJot(data).then(jotUi.updateJotSuccess).then(jotApi.indexJots).then(jotUi.runHandlebars).catch(jotUi.updateJotError);
};
...
var createJot = function createJot(data) {
  return $.ajax({
    method: 'POST',
...
var indexJots = function indexJots(data) {
  return $.ajax({
    method: 'GET',
    url: config.apiUrl + '/jots',
    headers: {
...
var destroyJot = function destroyJot(id) {
  return $.ajax({
    method: 'DELETE',
...
var updateJot = function updateJot(data) {
  return $.ajax({
    method: 'PATCH',
...
var indexJotsTemplate = __webpack_require__(17);

// Assistant functions

var runHandlebars = function runHandlebars(data) {
  $('#listOfJots').html('');
  var indexJotsHtml = indexJotsTemplate({ jots: data.jots });
...
var createJotSuccess = function createJotSuccess(data) {
  clearMessageDiv();
  $('#userFacingMessages').append('<p>You successfully created a new jot!</p>');
  clearFormFields();
};

var createJotError = function createJotError() {
  clearMessageDiv();
...
var indexJotsSuccess = function indexJotsSuccess(data) {
  clearMessageDiv();
...
module.exports = {
  createJotSuccess: createJotSuccess,
  createJotError: createJotError,
  indexJotsSuccess: indexJotsSuccess,
  indexJotsError: indexJotsError,
  destroyJotSuccess: destroyJotSuccess,
  destroyJotError: destroyJotError,
  updateJotSuccess: updateJotSuccess,
  updateJotError: updateJotError,
  runHandlebars: runHandlebars
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <div class=\"row singular-jot\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n    <div class=\"col-xs-10 jot-name-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n      <h3 data-title=\""
    ...
    + "      </h3>\n    </div>\n    <div class=\"col-xs-12 jot-content-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n      <p>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.content : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "      </p>\n    </div>\n    <form class=\"hidden update-form-jot-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n      <div class=\"form-group\">\n        <label for=\"update-jot-name-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Jot Name</label>\n        <input type=\"text\" class=\"form-control\" id=\"update-jot-name-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" name=\"jot[name]\" placeholder=\"Jot Name\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "\" required>\n        <label for=\"update-jot-content-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Jot Content</label>\n        <input type=\"text\" class=\"form-control\" id=\"update-jot-content-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" name=\"jot[content]\" placeholder=\"Got a thought? Write a jot!\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.content : stack1), depth0))
    + "\" required>\n        <button type=\"submit\" class=\"btn btn-default update-jot\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Save</button>\n      </div>\n    </form>\n    <div class=\"col-xs-12 btn-group\" role=\"group\">\n      <button type=\"button\" class=\"btn btn-default reveal-jot-editor\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Edit</button>\n      <button type=\"button\" class=\"btn btn-default destroy-jot\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Delete</button>\n    </div>\n  </div>\n";
  ...
  return "          "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.content : stack1), depth0))
    + "\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.jots : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
